  ...
  <right >
    <div id="right-up">
        ...
        <div id="right-up-icon">
          ...
          <span class="rui-icon-text" @click='cancel("titleManage", $event)'>
            <a href="#" class="rui-icon">
    ...
    <div id="right-table">
       ...
       <div class="person-info">
          <div class="left">
             <span class="label">职称管理</span> <span class="input"><inputCom inputName='applyName'   inputWidth="180px" inputHeight="40px" ></inputCom><span>
          </div>
