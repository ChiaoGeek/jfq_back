...
export default {
  ...
  mounted () {
    ...
    //请求的URL
    var resUrl = urlbase+'/user/api/guideProfiles?page=0&size='+this.perSize+'&sort=userId,ASC';
  ...
  methods: {
    edit: function(id, event){
      ...
      //给目前的实例注册一个事件
      //alert(1);
      var obj = {id: id, viewName: 'sgmEdit'};
    ...
    search: function(){
      ...
      var urlbase = this.$http.options.root;
      //请求的URL
      var resUrl = urlbase+'/user/api/guideProfiles?page=0&size='+this.perSize+'&sort=userId,ASC&filter='+this.filterString;
    ...
    ccp: function(value){
      ...
      if(this.filterString){
        var resUrl = urlbase+'/user/api/guideProfiles?page='+page+'&size='+this.perSize+'&sort=userId,ASC&filter='+this.filterString;
      }else{
        var resUrl = urlbase+'/user/api/guideProfiles?page='+page+'&size='+this.perSize+'&sort=userId,ASC';
      }
