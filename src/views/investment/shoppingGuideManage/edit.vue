  ...
  <right >
    <div id="right-up">
        ...
        <div id="right-up-icon">
          ...
          <span class="rui-icon-text" @click='cancel("shoppingGuideManage", $event)'>
            <a href="#" class="rui-icon">
...
export default {
  ...
  mounted () {
    ...
    //请求的URL
    var resUrl = urlbase+'/user/api/guideProfiles?filter=userId:'+this.itemPara;
