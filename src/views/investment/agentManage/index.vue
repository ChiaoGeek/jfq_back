...
export default {
  ...
  mounted () {
    ...
    //请求的URL
    var resUrl = urlbase+'/merchant/api/agents?page=0&size='+this.perSize+'&sort=id,ASC';
  ...
  methods: {
    ...
    search: function(){
      ...
      var urlbase = this.$http.options.root;
      //请求的URL
      var resUrl = urlbase+'/merchant/api/agents?page=0&size='+this.perSize+'&sort=id,ASC&filter='+this.filterString;
    ...
    ccp: function(value){
      ...
      if(this.filterString){
        var resUrl = urlbase+'/merchant/api/agents?page='+page+'&size='+this.perSize+'&sort=id,ASC&filter='+this.filterString;
      }else{
        var resUrl = urlbase+'/merchant/api/agents?page='+page+'&size='+this.perSize+'&sort=id,ASC';
      }
