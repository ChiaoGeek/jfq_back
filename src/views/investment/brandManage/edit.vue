  ...
  <right >
    ...
    <div id="right-table">
       ...
       <div class="person-info">
          <div class="left">
             <span class="label">品牌</span> <span class="input"><inputCom inputName='applyName'   inputWidth="180px" inputHeight="40px" ></inputCom><span>
          </div>
          <div class="right">
       ...
       <div class="person-info margin-top">
          <div class="left">
             <span class="label">描述</span> <span class="input"><inputCom inputName='applyName'   inputWidth="180px" inputHeight="40px" ></inputCom><span>
          </div>
