...
export default {
  ...
  mounted () {
    ...
    //请求的URL
    var resUrl = urlbase+'/merchant/api/stores?page=0&size='+this.perSize+'&sort=id,ASC';
  ...
  methods: {
    edit: function(id, event){
      ...
      //给目前的实例注册一个事件
      //alert(1);
      var obj = {id: id, viewName: 'storemEdit'};
    ...
    search: function(){
      ...
      var urlbase = this.$http.options.root;
      //请求的URL
      var resUrl = urlbase+'/merchant/api/stores?page=0&size='+this.perSize+'&sort=id,ASC&filter='+this.filterString;
    ...
    ccp: function(value){
      ...
      if(this.filterString){
        var resUrl = urlbase+'/merchant/api/stores?page='+page+'&size='+this.perSize+'&sort=id,ASC&filter='+this.filterString;
      }else{
        var resUrl = urlbase+'/merchant/api/stores?page='+page+'&size='+this.perSize+'&sort=id,ASC';
      }
